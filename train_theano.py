...
def train_with_sgd(
    model, X_train, y_train, learning_rate=0.005, nepoch=1, evaluate_loss_after=5
):
...
with open("data/reddit-comments-2015-08.csv", "rb") as f:
    ...
    sentences = [
        "%s %s %s" % (sentence_start_token, x, sentence_end_token) for x in sentences
    ]
